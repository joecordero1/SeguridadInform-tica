...
namespace SeguridadInformática.Migrations
{
    ...
    [Migration("20231211063124_segunda")]
            ...
            modelBuilder.Entity("RiesgoPorActivo", b =>
                {
                    ...
                    b.Property<int>("ActivoId_Activo")
                        .HasColumnType("int");

                    b.Property<int>("RiesgoId_Riesgo")
                        .HasColumnType("int");

                    b.HasKey("Id_Activo", "Id_Riesgo");

                    b.HasIndex("ActivoId_Activo");

                    b.HasIndex("RiesgoId_Riesgo");
            ...
            modelBuilder.Entity("RiesgoPorActivo", b =>
                {
                    b.HasOne("SeguridadInformática.Models.Activo", "Activo")
                        ...
                        .HasForeignKey("ActivoId_Activo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SeguridadInformática.Models.Riesgo", "Riesgo")
                        .WithMany("RiesgosPorActivo")
                        .HasForeignKey("RiesgoId_Riesgo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
